...
class Gpio:
    ...
    def initGpio(self, config):
        ...
        if self._is_enabled:
            ...
            logging.info(
                (
                    "GPIO enabled (lamp_pin=%d, trigger_pin=%d, "
    ...
    def rgbBlink(self):
        ...
        if self._is_enabled:
            self._gpio.rgbBlink(
                self._rgb, 0.5, 0.5, 0.1, 0.1, (1, 0, 0), (0, 0, 0), None
